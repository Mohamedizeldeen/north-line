...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // ─── Projects ───────────────────────────────────────────
        // Legacy English-only demo data; real project content is entered
        // bilingually through the admin panel.
        $projects = [
            [
                'title_en' => 'Al-Noor Medical Center Website',
                'slug_en' => 'al-noor-medical-center',
                'description_en' => 'A modern, responsive website for a medical center featuring online appointment booking, doctor profiles, department listings, and patient resources.',
                'content_en' => "Al-Noor Medical Center needed a professional online presence to serve their patients better. We built a comprehensive website with an intuitive appointment booking system, detailed doctor profiles with specializations, and a patient portal for accessing medical resources.\n\nThe site features a clean, accessible design optimized for all devices, ensuring patients can easily find information and book appointments from anywhere. We also integrated a content management system for the clinic staff to update doctor schedules and publish health articles.",
            ...
            [
                'title_en' => 'QuickMart E-Commerce Platform',
                'slug_en' => 'quickmart-ecommerce',
                'description_en' => 'Full-featured e-commerce platform with product management, order processing, payment integration, and real-time inventory tracking.',
                'content_en' => "QuickMart approached us to build a scalable e-commerce platform that could handle thousands of products and high traffic volumes. We delivered a full-stack solution with a powerful admin dashboard, multi-payment gateway integration (Stripe & PayPal), and automated inventory management.\n\nKey features include dynamic product filtering, wishlists, order tracking, email notifications, an analytics dashboard for the business owner, and a mobile-responsive storefront that converts visitors into customers.",
            ...
            [
                'title_en' => 'EduTrack Learning Management System',
                'slug_en' => 'edutrack-lms',
                'description_en' => 'A comprehensive LMS for schools and training centers with course management, student enrollment, grading, and progress tracking.',
                'content_en' => "EduTrack is a learning management system we built for educational institutions. It allows administrators to create courses, manage enrollments, track student progress, and generate detailed academic reports.\n\nThe platform supports video lessons, quizzes, assignments, and discussion forums. Teachers get a powerful dashboard to manage their classes, while students enjoy a clean interface to access their learning materials and track their grades.",
            ...
            [
                'title_en' => 'Flavor Hub Restaurant Website',
                'slug_en' => 'flavor-hub-restaurant',
                'description_en' => 'Modern restaurant website with online menu, table reservations, order-ahead functionality, and integration with delivery services.',
                'content_en' => "Flavor Hub wanted a website that reflects their brand identity and makes it easy for customers to explore their menu and make reservations. We created a visually stunning site with high-quality food photography, an interactive menu with filtering by category and dietary preferences.\n\nThe reservation system allows customers to book tables online, while the order-ahead feature lets them place takeout orders with estimated pickup times. The admin panel allows the restaurant to update menus, manage reservations, and view order analytics.",
            ...
            [
                'title_en' => 'PropertyVault Real Estate Platform',
                'slug_en' => 'propertyvault-real-estate',
                'description_en' => 'Real estate listing platform with advanced search, interactive maps, virtual tours, and agent management for a property company.',
                'content_en' => "PropertyVault is a comprehensive real estate platform designed to streamline property listings and connect buyers with agents. The platform features advanced search with filters for location, price range, property type, and amenities.\n\nWe integrated interactive maps for property locations, supported virtual tour embeds, and built agent profiles with contact forms. The admin dashboard allows property managers to list, edit, and track property inquiries in real time.",
            ...
            [
                'title_en' => 'FitZone Gym Management System',
                'slug_en' => 'fitzone-gym-management',
                'description_en' => 'Gym management system with member registration, class scheduling, trainer assignments, payment tracking, and attendance monitoring.',
                'content_en' => "FitZone needed a centralized system to manage their growing gym operations. We built a complete management platform that handles member registration, subscription plans, class scheduling, and trainer assignments.\n\nThe system includes automated payment reminders, attendance tracking via QR codes, and a member app where users can book classes, track their fitness progress, and communicate with trainers. The admin dashboard provides analytics on membership trends and revenue.",
        ...
        foreach ($systems as $system) {
            System::firstOrCreate(['slug_en' => $system['slug_en']], $system);
        }
        ...
        foreach ($posts as $post) {
            BlogPost::firstOrCreate(['slug_en' => $post['slug_en']], $post);
        }
